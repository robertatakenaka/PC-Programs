...
class SGMLXMLDocument(object):
    ...
    def fix(self):
        ...
        fixer = SGMLXMLFixer(self.sgmlfile.content, self.src_pkgfiles, sgmlhtmldoc)
        fixer.fix()
...
class SciPackageMaker(object):
    ...
    def _generate_pack_xml(self):
        pkg_renamer = PackageRenamer(self.src_pkgfiles, self.mkp_href_info_items)
